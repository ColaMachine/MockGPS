...
public class MainActivity extends AppCompatActivity
    ...
    private FloatingActionButton fabStop;//左下角的按钮
    ...
    ////////
        //sha1  89:A7:DF:04:B9:A9:17:97:EC:2B:DC:5A:18:EB:F2:6F:B8:EB:29:F3
    //    FE:8A:17:C9:0A:45:AC:29:8C:8E:10:8E:DD:17:55:E0:8D:32:04:A0
    //89:A7:DF:04:B9:A9:17:97:EC:2B:DC:5A:18:EB:F2:6F:B8:EB:29:F3
    ...
    private void setGroupListener() {
        ...
        radioButtonListener2 = new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.normalloc) {//正常定位
//                    mBaiduMap.setMapType(BaiduMap.MAP_TYPE_NORMAL);
                    mCurrentMode = MyLocationConfiguration.LocationMode.NORMAL;//将百度地图的状态改成正常
                ...
                if (checkedId == R.id.trackloc) {//如果选择的是跟踪
//                    mBaiduMap.setMapType(BaiduMap.MAP_TYPE_SATELLITE);
                    mCurrentMode = MyLocationConfiguration.LocationMode.FOLLOWING;//将百度地图的状态改成跟中
                    mBaiduMap.setMyLocationConfiguration(new MyLocationConfiguration(
                            mCurrentMode, true, mCurrentMarker));
...
//                    mBaiduMap.setMapType(BaiduMap.MAP_TYPE_SATELLITE);
    ...
    private void setFabListener() {
        ...
        fabStop = (FloatingActionButton) findViewById(R.id.fabStop);   //这是两个切换的按钮 用来设置当前的定位信息
...
//
                             ...
                             MockGpsService.latLngInfo = latLngInfo;
